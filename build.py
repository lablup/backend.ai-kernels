...
#build_common('tensorflow', '1.2-py36-gpu')
#build_common('tensorflow', '1.1-py36')
#build_common('tensorflow', '1.1-py36-gpu')
#build_common('tensorflow', '1.0-py36')
#build_common('tensorflow', '1.0-py36-gpu')

#
build_kernel('python-tensorflow', '1.12-py36')
#build_kernel('python-tensorflow', '1.12-py36-gpu')
build_kernel('python-tensorflow', '1.11-py36')
#build_kernel('python-tensorflow', '1.11-py36-gpu')
build_kernel('python-tensorflow', '1.10-py36')
#build_kernel('python-tensorflow', '1.10-py36-gpu')
build_kernel('python-tensorflow', '1.9-py36')
build_kernel('python-tensorflow', '1.9-py36-gpu')
build_kernel('python-tensorflow', '1.8-py36')
build_kernel('python-tensorflow', '1.8-py36-gpu')
build_kernel('python-tensorflow', '1.7-py36')
build_kernel('python-tensorflow', '1.7-py36-gpu')
build_kernel('python-tensorflow', '1.6-py36')
build_kernel('python-tensorflow', '1.6-py36-gpu')
...
#build_kernel('python-tensorflow', '1.2-py36-gpu')
#build_kernel('python-tensorflow', '1.1-py36')
#build_kernel('python-tensorflow', '1.1-py36-gpu')
