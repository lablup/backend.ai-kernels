...
build_common('tensorflow', '1.7-py36', squash=True)
build_common('tensorflow', '1.7-py36-gpu', squash=True)
build_common('tensorflow', '1.6-py36', squash=True)
build_common('tensorflow', '1.6-py36-gpu', squash=True)
...
build_kernel('python-tensorflow', '1.7-py36-gpu', squash=True, latest=True)
build_kernel('python-tensorflow', '1.6-py36', squash=True)
build_kernel('python-tensorflow', '1.6-py36-gpu', squash=True, latest=True)
...
build_kernel('python-tensorflow', '1.6-py36-dense', latest=True, squash=True)
build_kernel('python-tensorflow', '1.6-py36-dense-gpu', latest=True, squash=True)
