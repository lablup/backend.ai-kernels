...
build_kernel('c',       'gcc6.3-alpine')
build_kernel('cpp',     'gcc6.3-alpine')
build_kernel('java',    '8-alpine')
build_kernel('rust',    '1.17-alpine')
build_kernel('go',      '1.9-alpine')
build_kernel('go',      '1.8-alpine')
#build_kernel('haskell', 'ghc8.2-debian')
build_kernel('lua',     '5.3-alpine')
build_kernel('php',     '7-alpine')
build_kernel('nodejs',  '6-alpine')
build_kernel('nodejs',  '8-alpine')
build_kernel('nodejs',  '10-alpine')
build_kernel('julia',   '0.6-debian')
build_kernel('r',       '3.3-alpine')
...
build_common('bazel', '0.15-debian')
