...
#
build_kernel('python-tensorflow', '1.0-py36', squash=True)
build_kernel('python-tensorflow', '1.0-py36-cuda8', squash=True)
build_kernel('python-tensorflow', '1.1-py36', squash=True)
build_kernel('python-tensorflow', '1.1-py36-cuda8', squash=True)
build_kernel('python-tensorflow', '1.2-py36', squash=True)
