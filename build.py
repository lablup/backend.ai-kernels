...
build_kernel('base-python-minimal', '3.6-conda', squash=True, latest=True)
...
build_kernel('nodejs',  '8-alpine',   latest=True)
build_kernel('nodejs',  '9-alpine',   latest=True)
...
#
build_kernel('python-tensorflow', '1.8-py36', latest=True)
build_kernel('python-tensorflow', '1.8-py36-gpu', latest=True)
build_kernel('python-tensorflow', '1.7-py36', latest=True)
build_kernel('python-tensorflow', '1.7-py36-gpu', latest=True)
