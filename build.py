...
build_kernel('c',       'gcc6.3-alpine', squah=True)
build_kernel('cpp',     'gcc6.3-alpine', squah=True)
build_kernel('java',    '8-alpine', squah=True)
build_kernel('rust',    '1.17-alpine', squah=True)
build_kernel('go',      '1.9-alpine', squah=True)
build_kernel('go',      '1.8-alpine', squah=True)
#build_kernel('haskell', 'ghc8.2-debian')
build_kernel('lua',     '5.3-alpine', squah=True)
build_kernel('php',     '7-alpine', squah=True)
build_kernel('nodejs',  '6-alpine', squah=True)
build_kernel('nodejs',  '8-alpine', squah=True)
build_kernel('nodejs',  '10-alpine', squah=True)
build_kernel('julia',   '0.6-alpine', squah=True)
build_kernel('r',       '3.3-alpine', squah=True)
...
#
build_kernel('python-tensorflow', '1.12-py36', squah=True)
build_kernel('python-tensorflow', '1.12-py36-gpu', squah=True)
build_kernel('python-tensorflow', '1.11-py36', squah=True)
build_kernel('python-tensorflow', '1.11-py36-gpu', squah=True)
build_kernel('python-tensorflow', '1.10-py36', squah=True)
build_kernel('python-tensorflow', '1.10-py36-gpu', squah=True)
build_kernel('python-tensorflow', '1.9-py36', squah=True)
build_kernel('python-tensorflow', '1.9-py36-gpu', squah=True)
build_kernel('python-tensorflow', '1.8-py36', squah=True)
build_kernel('python-tensorflow', '1.8-py36-gpu', squah=True)
build_kernel('python-tensorflow', '1.7-py36', squah=True)
build_kernel('python-tensorflow', '1.7-py36-gpu', squah=True)
build_kernel('python-tensorflow', '1.6-py36', squah=True)
build_kernel('python-tensorflow', '1.6-py36-gpu', squah=True)
build_kernel('python-tensorflow', '1.5-py36', squah=True)
build_kernel('python-tensorflow', '1.5-py36-gpu', squah=True)
