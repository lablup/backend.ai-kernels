...
RUN curl https://bootstrap.pypa.io/get-pip.py | python3 && \
    ...
    python3 -m pip install --no-cache-dir https://download.pytorch.org/whl/cu100/torch-1.0.0-cp36-cp36m-linux_x86_64.whl && \
...
RUN python -m ipykernel install --display-name "PyTorch 1.0 on Python 3.6 (CUDA 10.0)" && \
