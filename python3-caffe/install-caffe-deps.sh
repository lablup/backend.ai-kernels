...
sed -i 's@/usr/include/python2.7@/home/sorna/.pyenv/versions/3.5.1/include/python3.5m@' Makefile.config
sed -i 's@/usr/lib/python2.7/dist-packages/numpy@/home/sorna/.pyenv/versions/3.5.1/lib/python3.5/site-packages/numpy@' Makefile.config
sed -i 's@\(PYTHON_LIB := .*\)@\1 /usr/lib/x86_64-linux-gnu /home/sorna/.pyenv/versions/3.5.1/lib@' Makefile.config
