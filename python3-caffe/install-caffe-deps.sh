...
sed -i "s@/usr/include/python2.7@/home/sorna/.pyenv/versions/$SORNA_PYTHON_VERSION/include/python3.5m@" Makefile.config
sed -i "s@/usr/lib/python2.7/dist-packages/numpy@/home/sorna/.pyenv/versions/$SORNA_PYTHON_VERSION/lib/python3.5/site-packages/numpy@" Makefile.config
