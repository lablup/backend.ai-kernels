...
Name=MATLAB R2024a
Comment=
Exec=/opt/matlab/R2024a/bin/matlab
Icon=/opt/matlab/R2024a/bin/glnxa64/cef_resources/matlab_icon.png
Path=
Terminal=true
StartupNotify=false
...
cat > /home/work/.vnc/xstartup << 'XSTARTUP'
#!/bin/sh
xhost +
...
# Launch XFCE components directly (bypass xfce4-session to avoid seccomp issues)
xfsettingsd &
xfwm4 &
xfce4-panel &
xfdesktop &

# Auto-launch MATLAB in xterm (desktop icons cannot spawn apps due to seccomp restrictions)
sleep 3 && xterm -e /opt/matlab/R2024a/bin/matlab &
