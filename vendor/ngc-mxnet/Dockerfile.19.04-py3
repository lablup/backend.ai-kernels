FROM nvcr.io/nvidia/mxnet:19.04-py3
# NGC MXnet 19.04 (python 3.5/cuda)
...
RUN /usr/bin/python3 -m ipykernel install --display-name "Python 3.5 (NGC/MXnet19.04) on Backend.AI" && \
